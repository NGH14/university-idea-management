...
const fakeData = [
    {ideaId: 1, title: "sadsa", user:{name: "Data Fake 01"}, content: "Data fake demo 01", createAt: "2022-03-15T13:45:30"},
    {ideaId: 1, title: "sadsa", user:{name: "Data Fake 02"}, content: "Data fake demo 02", createAt: "2022-03-15T13:45:30"},
    {ideaId: 2, title: "sadsa", user:{name: "Data Fake 01 _ 01"}, content: "Data fake demo 01", createAt: "2022-03-15T13:45:30"},
    {ideaId: 2, title: "sadsa", user:{name: "Data Fake 02 _ 02"}, content: "Data fake demo 02", createAt: "2022-03-15T13:45:30"}
]
function CommentIdea({data, ideaId}){
    ...
    const renderContent = () => {
        const comments =  _.map( dataComment, item => {
            return <Paper style={{ padding: 15 , boxShadow: "none"}}>
                <Grid container wrap="nowrap" spacing={2}>
                    ...
                    <Grid justifyContent="left" item xs zeroMinWidth >
                        ...
                        <div style={{ borderRadius: 15, padding: 10, background: "#F0F2F5"}}>
                            <p style={{ margin: 0, textAlign: "left", fontWeight: "bold", fontSize: 18, color: "black"}}>
                                { item?.user?.name }
                            </p>
        ...
        const buttonMore = <div style={{textAlign: "center", marginTop: 15, marginBottom: 15}} onClick={()=>{onShowMoreComment()}}>
    ...
    return <>
        <div>
            ...
            >
                ...
                <IconButton color="primary" sx={{ p: '10px' }} aria-label="directions" onClick={()=>{onCreateComment()}}>
                    <SendIcon />
                </IconButton>
            </Paper>
        </div >
