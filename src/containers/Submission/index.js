        ...
        await axios
            ...
            .then(
                axios.spread(function (resSub, resIdeas) {
                    ...
                    setPaginationIdea({...paginationIdea, total: resSub?.data?.result?.total })
    ...
    const renderIdeaView = () => {
        ...
        return (
            ...
            >
                ...
                <IdeaSubViewStaff paginationIdea={paginationIdea} setPaginationIdea={setPaginationIdea}  ideaData={data.ideas} subData={data?.sub} />
            </fieldset>
        );
    };
